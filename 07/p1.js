...
function getSumOfDirectoriesWithTotalSizeOfAtMost100000(file) {
    let totalSize = 0;
    ...
    function getFileSize(file) {
        if (file.getChildren().length === 0) {
            ...
            file.getChildren().forEach(child => {
                size += parseInt(getFileSize(child));
            })
...
console.log(getSumOfDirectoriesWithTotalSizeOfAtMost100000(rootFile))
